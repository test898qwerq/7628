...
wy934_mtdlayout_8M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,6336k(rootfs),1408k(kernel),64k(nvram),64k(art)ro,7744k@0x50000(firmware)
...
$(eval $(call SingleProfile,AthLzma,64k,WY_A934X_TEST,wy-a934x-test,WY-A934X-TEST,ttyS0,115200,$$(wy934_mtdlayout_8M),RKuImage))
